...
// .wrangler/tmp/bundle-CLTQt9/strip-cf-connecting-ip-header.js
...
var CreateSupportTicketSchema = external_exports.object({
  subject: external_exports
    .string()
    .min(5)
    .describe('A clear, concise subject line for the ticket'),
...
var ViewTicketsSchema = external_exports.object({
  status: external_exports
    .array(external_exports.enum(['OPEN', 'IN_PROGRESS', 'WAITING_ON_USER', 'RESOLVED', 'CLOSED']))
    .optional()
...
// .wrangler/tmp/bundle-CLTQt9/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-CLTQt9/middleware-loader.entry.ts
