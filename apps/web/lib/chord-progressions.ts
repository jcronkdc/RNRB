...
// Chord substitution suggestions
export const CHORD_SUBSTITUTIONS: { [key: string]: { chord: string; description: string; vibe: string }[] } = {
  'C': [
...
export function getChordSubstitutions(chord: string): { chord: string; description: string; vibe: string }[] {
...
export function getProgressionsByFilter(filter?: { genre?: string; mood?: string }): ProgressionCategory[] {
