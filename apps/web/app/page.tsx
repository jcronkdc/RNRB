        ...
        <div className="container">
              ...
              <div className="feature-card-content">
                ...
                <div>
                  ...
                  <p className="feature-desc-large">
                    ...
                    instant messaging with voice messages, presence tracking, multi-cursor editing,
                    and pinned comments on lyrics/audio.
                  </p>
                  <ul className="feature-list">
          ...
          <div className="secondary-features grid gap-4 md:grid-cols-3 lg:grid-cols-4">
            ...
            <Link href="/features/website-builder" className="feature-card-small group">
              <div className="feature-icon-small" style={{ background: 'rgba(56, 189, 248, 0.1)' }}>
                <svg
          ...
          <div className="mx-auto max-w-3xl">
            <div className="faq-item">
              ...
              <p className="faq-answer">
                You do. Always. We never claim any rights to your work. Your music is yours.
              </p>
            </div>
            <div className="faq-item">
              <h3 className="faq-question">Is my data secure?</h3>
              <p className="faq-answer">
                Yes. End-to-end encryption, GDPR compliant, and industry-standard security
                practices.
              </p>
            </div>
            <div className="faq-item">
              ...
              <p className="faq-answer">
                Export anytime in standard formats—MIDI, PDF, WAV, MP3. No lock-in ever.
              </p>
            </div>
            <div className="faq-item">
              <h3 className="faq-question">How does the AI work?</h3>
              <p className="faq-answer">
                Powered by Claude, our AI assists—never replaces—your creativity. You stay in
                control.
              </p>
            </div>
          </div>
