...
export default function LoginForm() {
  ...
  return (
    ...
    >
      <motion.div
        className="flex items-center justify-center gap-2 text-xs font-medium uppercase tracking-[0.2em] text-(--muted)"
      ...
      >
        ...
        <div className="border-(--border)/60 flex items-center justify-center gap-2 rounded-2xl border bg-(--surface) px-4 py-3 text-xs text-(--muted)">
