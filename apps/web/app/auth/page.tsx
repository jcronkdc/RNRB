    ...
    <div className="flex min-h-screen bg-black">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-20">
          <div className="absolute top-0 left-0 w-full h-full bg-[url('/noise.png')] opacity-50" />
        ...
        <div className="relative z-10 flex flex-col items-center justify-center w-full p-12 text-white">
          ...
          >
            ...
            <div className="mb-8 flex justify-center">
              <div className="relative w-32 h-32 bg-white/10 backdrop-blur-sm rounded-2xl p-6 shadow-2xl border border-white/20">
                <Image
                  src="/rnrdark.png"
      ...
      <div className="flex w-full lg:w-1/2 items-center justify-center p-8">
        ...
        >
          ...
          <div className="lg:hidden text-center mb-8">
            <div className="inline-flex items-center justify-center w-20 h-20 bg-orange-500/10 backdrop-blur-sm rounded-xl p-4 mb-4">
              <Image
                src="/rnrdark.png"
                alt="Rock N' Roll Basement Logo"
                width={80}
        ...
        <div className="space-y-4">
          {/* Email Magic Link - PRIMARY METHOD */}
            <form onSubmit={handleEmailSignIn} className="space-y-4">
              ...
              <input
                ...
                required
                disabled={loading}
                className="w-full px-4 py-3 bg-gray-900 border border-gray-800 rounded-xl text-white placeholder:text-gray-500 focus:border-orange-500 focus:ring-2 focus:ring-orange-500/20 focus:outline-none disabled:opacity-50 transition-all"
              />
          ...
          <button
            ...
            disabled={loading}
              className="w-full rounded-xl bg-white hover:bg-gray-100 px-4 py-3 text-base font-semibold text-gray-900 shadow-lg transition-all transform hover:scale-[1.02] disabled:opacity-50 disabled:hover:scale-100"
          >
          ...
          By continuing, you agree to our{' '}
            <Link href="/terms" className="text-orange-500 hover:text-orange-400 hover:underline transition-colors">
            Terms of Service
          </Link>{' '}
          and{' '}
            <Link href="/privacy" className="text-orange-500 hover:text-orange-400 hover:underline transition-colors">
            Privacy Policy
          </Link>
          .
        </p>
