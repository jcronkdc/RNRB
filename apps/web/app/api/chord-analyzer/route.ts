...
function parseChord(chord: string): { root: string; quality: 'major' | 'minor' | 'seventh' | 'unknown' } {
...
function analyzeKey(chords: string[]): Array<{ key: string; mode: 'major' | 'minor'; confidence: number }> {
