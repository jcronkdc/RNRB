...
export async function POST(request: NextRequest) {
  try {
    ...
    const checkoutSession = await stripe.checkout.sessions.create({
      ...
      success_url: `${process.env.NEXT_PUBLIC_APP_URL || 'http://localhost:3001'}/u/${artistUsername}/merch?success=true&session_id={CHECKOUT_SESSION_ID}`,
      cancel_url: `${process.env.NEXT_PUBLIC_APP_URL || 'http://localhost:3001'}/u/${artistUsername}/merch`,
