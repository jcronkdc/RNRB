  ...
  return (
    <motion.div
      ...
      className={`group relative overflow-hidden rounded-2xl border transition-all duration-300 ${
        isActive
          ? 'border-green-500/30 bg-linear-to-br from-green-500/10 to-white/2 hover:border-green-500/50'
          : isPast
            ? 'border-white/5 bg-white/2 opacity-60'
            : 'border-white/10 bg-linear-to-br from-white/8 to-white/2 hover:border-white/20 hover:shadow-xl hover:shadow-black/20'
      }`}
    >
      {/* Gradient glow on hover */}
      <div
        className={`pointer-events-none absolute -inset-px rounded-2xl bg-linear-to-br ${
      ...
      <div className="relative z-10 mx-auto max-w-5xl px-4 pb-16">
        ...
        >
          ...
          <motion.button
            ...
            disabled={isCreating}
            className="group relative overflow-hidden rounded-2xl border border-blue-500/30 bg-linear-to-br from-blue-500/10 to-white/2 p-6 text-left transition-all duration-300 hover:border-blue-500/50 hover:shadow-xl hover:shadow-blue-500/10 disabled:cursor-not-allowed disabled:opacity-50"
          >
            {/* Gradient glow */}
          ...
          {/* Join by Code */}
          <div className="group relative overflow-hidden rounded-2xl border border-white/10 bg-linear-to-br from-white/8 to-white/2 p-6 transition-all duration-300 hover:border-white/20">
            <div className="pointer-events-none absolute -inset-px rounded-2xl bg-linear-to-br from-green-500 to-emerald-500 opacity-0 blur-xl transition-opacity duration-500 group-hover:opacity-10" />

            <div className="relative z-10">
              <div className="mb-5 flex h-14 w-14 items-center justify-center rounded-2xl bg-linear-to-br from-emerald-500 to-green-600 shadow-lg">
              ...
              <div className="flex gap-2">
                ...
                <button
                  ...
                  className="rounded-xl bg-linear-to-r from-green-500 to-emerald-500 px-5 py-2.5 text-sm font-medium text-white shadow-lg shadow-green-500/25 transition-all hover:shadow-green-500/40"
                >
                  Join
                </button>
              </div>
            ...
            >
              ...
              <div className="p-6">
                <div className="mb-6 flex items-center gap-3">
                  <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-linear-to-br from-purple-500 to-purple-600">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex gap-3 pt-4">
                    ...
                    <button
                      ...
                      disabled={isCreating}
                      className="flex flex-1 items-center justify-center gap-2 rounded-xl bg-linear-to-r from-purple-500 to-pink-500 px-4 py-3 font-medium text-white shadow-lg shadow-purple-500/25 transition-all hover:shadow-purple-500/40 disabled:opacity-50"
                    >
                      {isCreating ? (
                        'Creating...'
                      ) : (
        ...
        {copied === 'scheduled' && (
          <motion.div
            ...
            animate={{ opacity: 1, y: 0 }}
            exit={{ opacity: 0, y: 50 }}
            className="fixed bottom-8 left-1/2 z-50 -translate-x-1/2 rounded-xl bg-linear-to-r from-green-500 to-emerald-500 px-6 py-3 text-white shadow-2xl shadow-green-500/30"
          >
            <div className="flex items-center gap-2">
        ...
        <motion.div
          ...
          className="mt-16 overflow-hidden rounded-2xl border border-white/10 bg-linear-to-br from-white/6 to-white/2 p-8"
        >
          ...
          <div className="grid grid-cols-2 gap-6 text-center md:grid-cols-4">
            {FEATURES.map((feature, index) => (
              <motion.div
                ...
                className="group"
              >
                <div className="mx-auto mb-3 flex h-12 w-12 items-center justify-center rounded-xl bg-linear-to-br from-white/10 to-white/5 transition-transform duration-300 group-hover:scale-110">
