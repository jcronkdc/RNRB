...
export default function DashboardPage() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Hero Section - Artist Sanctuary */}
      <div className="relative overflow-hidden border-b border-border/50 bg-gradient-to-br from-purple-900/10 via-background to-brand-primary/10">
        {/* Music-Themed Background Elements */}
        <div className="absolute inset-0 opacity-5">
          <div className="absolute top-10 right-1/4 text-9xl">🎸</div>
        ...
        <div className="absolute inset-0">
          ...
          <div className="absolute bottom-0 left-1/4 w-96 h-96 bg-brand-primary/15 rounded-full blur-3xl" />
          <div className="absolute top-1/2 right-1/3 w-64 h-64 bg-pink-500/10 rounded-full blur-2xl" />
        </div>
