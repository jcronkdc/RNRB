  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-black via-gray-900/50 to-black">
      ...
      <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 sm:py-8 lg:px-8 lg:py-12">
        {/* Improved Stats Overview - Better Mobile Grid */}
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          <div className="rounded-xl border border-gray-800 bg-gradient-to-b from-gray-900 to-black p-3 transition-all hover:border-orange-500/50 hover:shadow-lg sm:p-4 lg:p-5">
            <p className="mb-1 text-xs text-gray-400 sm:mb-2 sm:text-sm">Active Projects</p>
            <p className="text-xl font-bold text-white sm:text-2xl lg:text-3xl">{projects.length}</p>
          </div>
          <div className="rounded-xl border border-gray-800 bg-gradient-to-b from-gray-900 to-black p-3 transition-all hover:border-orange-500/50 hover:shadow-lg sm:p-4 lg:p-5">
            <p className="mb-1 text-xs text-gray-400 sm:mb-2 sm:text-sm">Total Songs</p>
            <p className="text-xl font-bold text-white sm:text-2xl lg:text-3xl">
              {projects.reduce((sum, p) => sum + (p.song_count || 0), 0)}
            </p>
          </div>
          <div className="rounded-xl border border-gray-800 bg-gradient-to-b from-gray-900 to-black p-3 transition-all hover:border-orange-500/50 hover:shadow-lg sm:p-4 lg:p-5">
            <p className="mb-1 text-xs text-gray-400 sm:mb-2 sm:text-sm">Collaborators</p>
            <p className="text-xl font-bold text-white sm:text-2xl lg:text-3xl">
              {projects.reduce((sum, p) => sum + (p.collaborator_count || 1), 0)}
            </p>
          </div>
          <div className="rounded-xl border border-gray-800 bg-gradient-to-b from-gray-900 to-black p-3 transition-all hover:border-orange-500/50 hover:shadow-lg sm:p-4 lg:p-5">
            <p className="mb-1 text-xs text-gray-400 sm:mb-2 sm:text-sm">Sessions</p>
            <p className="text-xl font-bold text-white sm:text-2xl lg:text-3xl">
