...
function SortableSong({
  ...
  return (
    <div
      ...
      className="rnrb-card group border-border from-surface to-surface-muted hover:border-brand-primary/30 mb-3 border-2 bg-linear-to-r p-4 transition-all"
    >
        ...
        <div className="flex-1">
          ...
          {notesExpanded && (
            <textarea
              ...
              className="border-border bg-surface focus:border-brand-primary focus:ring-brand-primary/20 mt-2 w-full resize-none rounded-lg border px-3 py-2 text-sm outline-hidden focus:ring-2"
              rows={2}
            />
          )}
        </div>
...
export function CollaborativeSetlistBuilder({
  ...
  return (
    <div className="space-y-6">
      {/* Header Stats */}
      <Card className="rnrb-card border-brand-primary/30 from-brand-primary/10 bg-linear-to-r to-transparent p-6">
            ...
            <div className="mb-6 flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                ...
                <div className="relative">
                  ...
                  {showExportMenu && (
                    <div className="border-border bg-surface absolute top-full right-0 z-10 mt-2 w-48 rounded-lg border shadow-xl">
                      <button
