...
export function AIChatAssistant({ onSuggestion, projectContext }: AIChatAssistantProps) {
  ...
  return (
    <div className="relative">
      ...
      {isOpen && (
        <div className="border-border bg-surface absolute right-0 bottom-full z-50 mb-2 w-96 rounded-lg border p-4 shadow-2xl">
          ...
          <div className="space-y-3">
            <textarea
              ...
              className="border-border bg-surface-muted text-foreground focus:border-brand-primary w-full resize-none rounded border px-3 py-2 text-sm focus:outline-hidden"
              rows={3}
            />
