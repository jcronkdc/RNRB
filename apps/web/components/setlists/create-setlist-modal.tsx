      ...
      {isOpen && (
        <>
          ...
          <div className="pointer-events-none fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            >
              {/* Header */}
              <div className="border-border bg-background flex flex-shrink-0 items-center justify-between border-b px-6 py-4">
                <div>
                        ...
                        <div className="max-h-96 space-y-2 overflow-y-auto pr-2">
                          {availableSongs.map((song) => (
                            <button
                              ...
                              className="border-border bg-surface hover:border-brand-primary group w-full rounded-lg border p-3 text-left transition-all"
                            >
                              <div className="flex items-center justify-between">
                                ...
                                <Plus className="text-brand-primary ml-2 h-4 w-4 flex-shrink-0 opacity-0 transition-opacity group-hover:opacity-100" />
                              </div>
                            </button>
                          ))}
                        </div>
                        ...
                        >
                          {setlistSongs.map((song, index) => (
                            <Reorder.Item
                              key={song.id}
                              value={song.id}
                              className="border-brand-primary/30 bg-brand-primary/5 group cursor-move rounded-lg border p-3"
                            >
                              <div className="flex items-center gap-3">
                                <GripVertical className="text-muted-foreground h-4 w-4 flex-shrink-0" />
                                <span className="bg-brand-primary text-brand-primary-foreground flex h-6 w-6 flex-shrink-0 items-center justify-center rounded-full text-sm font-bold">
                                  {index + 1}
                                </span>
                                <div className="min-w-0 flex-1">
                                  <p className="truncate font-medium">{song.title}</p>
                                ...
                                <button
                                  ...
                                  className="text-muted-foreground flex-shrink-0 p-1 opacity-0 transition-all hover:text-red-500 group-hover:opacity-100"
              ...
              {/* Footer */}
              <div className="border-border bg-background flex flex-shrink-0 items-center justify-between border-t px-6 py-4">
