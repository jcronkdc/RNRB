      ...
      <div className="border-border bg-surface-muted border-t p-4">
        ...
        {showAIHelper && (
          <div className="rnrb-card mb-4 border-purple-500/20 bg-purple-500/5 p-4">
            ...
            <textarea
              ...
              className="border-border bg-surface text-foreground focus:border-brand-primary focus:ring-brand-primary/20 mb-3 w-full resize-none rounded border px-3 py-2 text-sm focus:ring-2 focus:outline-hidden"
              rows={2}
            />
        ...
        <div className="flex gap-2">
          <input
            ...
            className="border-border bg-surface text-foreground placeholder-muted-foreground focus:border-brand-primary focus:ring-brand-primary/20 flex-1 rounded-lg border px-4 py-2.5 text-sm transition focus:ring-2 focus:outline-hidden"
          />
          <button
