        ...
        <>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            <motion.div
              ...
              className="bg-card border-border w-full max-w-2xl overflow-hidden rounded-xl border shadow-2xl"
            >
              {/* Header */}
              ...
              <div className="max-h-[600px] overflow-y-auto p-6">
                {/* Global Shortcuts */}
                <div className="mb-6">
                  <h3 className="text-muted-foreground mb-3 flex items-center gap-2 text-sm font-medium uppercase tracking-wide">
    ...
    <div className="hover:bg-muted/50 flex items-center justify-between rounded-lg p-3 transition-colors">
      ...
      <div className="flex items-center gap-1">
        {keys.map((key, index) => (
          <kbd
            key={index}
            className="border-border bg-muted rounded border px-2 py-1 text-xs font-medium shadow-sm"
          >
            {key}
          </kbd>
        ))}
