...
const GUIDE_SECTIONS: GuideSection[] = [
  {
    ...
    whatIs: 'A PRO (Performance Rights Organization) collects royalties when your music is performed publicly - on radio, TV, streaming, live venues, etc. This is often the FIRST step in protecting your music.',
  ...
  },
  {
    ...
    whatIs: 'IPI (Interested Party Information) is a unique 9-11 digit number that identifies you as a songwriter or publisher in the global music database. Think of it like a Social Security Number for your music career.',
    whereToGet: 'Automatically assigned by your PRO when you become a member. You will receive this in your PRO welcome email or account dashboard.',
  ...
  },
  {
    ...
    whatIs: 'ISWC (International Standard Musical Work Code) is like an ISBN for books, but for songs. It uniquely identifies your musical COMPOSITION (the song itself - melody, lyrics, chords) worldwide.',
    whereToGet: 'Register through your PRO when you register the song, or use the US Copyright Office. Most PROs assign this automatically.',
  ...
  },
  {
    ...
    whatIs: 'ISRC (International Standard Recording Code) identifies a specific RECORDING of your song. If you re-record the same song, it gets a new ISRC. This tracks streams, sales, and radio plays.',
    whereToGet: 'Get from your distributor (CD Baby, DistroKid, TuneCore), recording studio, or register as an ISRC manager yourself.',
  ...
  },
  {
    ...
    whatIs: 'While your music is automatically copyrighted when you create it, REGISTERING with the US Copyright Office gives you legal benefits: you can sue for infringement, claim statutory damages, and prove ownership in court.',
    whereToGet: 'Register directly with the U.S. Copyright Office online system (eCO). This is separate from your PRO registration.',
    ...
    <div className="space-y-6">
        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <p className="mt-2 text-sm text-gray-300">
              Follow this step-by-step guide to properly protect your music and collect all the royalties you deserve.
              We've included direct links to make the process as easy as possible.
            </p>
          </div>
        </div>
      </Card>
        ...
        <ol className="space-y-3 text-sm">
          <li className="flex items-start gap-3">
            ...
            <div>
              ...
              <span className="text-gray-400"> - Start collecting performance royalties (Free, 1-2 weeks)</span>
            </div>
          </li>
          <li className="flex items-start gap-3">
            <span className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-purple-500/20 font-bold text-purple-400">
            ...
            <div>
              ...
              <span className="text-gray-400"> - Automatically assigned by your PRO (Free, immediate)</span>
            </div>
          </li>
          <li className="flex items-start gap-3">
            <span className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-purple-500/20 font-bold text-purple-400">
            ...
            <div>
              ...
              <span className="text-gray-400"> - Get ISWC and start tracking performances (Free, instant)</span>
            </div>
          </li>
          <li className="flex items-start gap-3">
            <span className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-purple-500/20 font-bold text-purple-400">
            ...
            <div>
              ...
              <span className="text-gray-400"> - From distributor or registrar (Free with distributor)</span>
            </div>
          </li>
          <li className="flex items-start gap-3">
            <span className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-purple-500/20 font-bold text-purple-400">
            ...
            <div>
              ...
              <span className="text-gray-400"> - For maximum legal protection ($65, 6-8 months)</span>
            </div>
          </li>
        </ol>
      </Card>
          ...
          return (
            ...
            >
              ...
              >
                ...
                <ArrowRight className={`h-5 w-5 shrink-0 text-gray-500 transition ${isExpanded ? 'rotate-90' : ''}`} />
              </button>
                  ...
                  {section.format && (
                    <div>
                      ...
                      <div className="rounded-lg bg-gray-800 p-3">
                        ...
                        {section.example && (
                          <p className="mt-1 font-mono text-xs text-gray-500">Example: {section.example}</p>
                        )}
                      </div>
                    </div>
                  )}
      ...
      <Card className="border-blue-500/30 bg-blue-500/5 p-4">
        <p className="text-sm text-gray-300">
          ...
          Start with PRO membership (free) and register your songs. Get ISRCs when you're ready to distribute 
          your music. Copyright registration is optional but recommended for commercial releases.
        </p>
      </Card>
    </div>
  );
