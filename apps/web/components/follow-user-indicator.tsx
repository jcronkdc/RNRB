    ...
    <AnimatePresence>
      {followingMember && (
        <motion.div
          ...
          exit={{ opacity: 0, y: -20 }}
          className={`border-border border-brand-primary bg-brand-primary/10 fixed top-4 left-1/2 z-50 flex -translate-x-1/2 items-center gap-3 rounded-full border px-4 py-2 shadow-lg ${className}`}
        >
          {/* Following indicator */}
          <div className="flex items-center gap-2">
            <UserCheck className="text-brand-primary h-4 w-4" />
