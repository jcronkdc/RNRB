        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <select
              ...
              disabled={isSending || success}
              className="focus:border-primary focus:ring-primary/20 border-border bg-surface h-12 w-full rounded-2xl border px-4 text-base focus:ring-2 focus:outline-hidden"
            >
